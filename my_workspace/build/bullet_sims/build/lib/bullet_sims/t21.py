...
# Impleent joint space PD controller 
...
while not done:
    ...
    simulator.debug()
    robot.update()
    #print("Current joint positions:", robot._q[7:30])  # Print joint positions of the actuated joints
    print("Size oq q matrix:", robot._q.shape, "Size of v matrix:", robot._v.shape)
    ...
    K_d[0:12] = 10 #legs 
    K_d[12:] = 3
    tau = K_p * (q_actuated_home - robot._q[7:39]) + K_d * (-robot._v[6:38])  # PD control law
